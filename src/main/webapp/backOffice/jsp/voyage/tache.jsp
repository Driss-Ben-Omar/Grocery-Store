...
function filterFunction() {
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table " id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                             <th>ID</th><th>Cin</th><th>Nom Complet</th><th>Matricule</th><th>Marque</th><th></th><th></th><th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                 ...
                                 <td>${t.id }</td>
                                  ...
                                  <td>${t.marque }</td>
                                    ...
                                    <td>
                                      ...
                                      <button  class="btn btn-danger" data-toggle="modal" data-target="#supprimerModal${t.id }">
                                      	<i class="fa fa-trash" aria-hidden="true"></i>
                                      </button>
                                  </td>
                                  <td>
                                        <button type="submit"  class="btn btn-warning" data-toggle="modal" data-target="#myModaledit${t.id }">
                                       	<i class="fa fa-cogs" aria-hidden="true"></i>
                                        </button>
                                  </td>
                                   <td>
                       					<a href="voireCommandesinTache.do?id=${t.id }"><button type="submit" class="btn btn-primary">Commandes</button></a>
                                  </td>
                                </tr>
                              </c:forEach>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
          ...
          <c:forEach items="${model.taches}" var="t">
         <div class="modal fade" id="supprimerModal${t.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">Sélectionnez "supprimer" ci-dessous si vous souhaitez supprimer cette tache </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                   <a href="supprimerTache.do?id=${t.id}"><button type="submit" class="btn btn-danger">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
    
    <div id="myModaledit${t.id}" class="modal fade" role="dialog">
      <div class="modal-dialog">
    
        <!-- Modal content-->
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">editer Voyage</h4>
          ...
          <div class="modal-body">
            ...
            <form action="updateTache.do" method="post">
                <div  hidden class="form-group">
                     ...
                     <input type="text" name="id" class="form-control" value="${t.id}"/>
                </div>
                
                <div class="form-group">
                     <label class="control-label">CIN :</label>
                     <input type="text" name="cin" class="form-control" value="${t.cin}"/>
                 </div>
                 
                <div class="form-group">
                      <label class="control-label">Matricule :</label>
                      <input type="text" name="matricule" class="form-control" value="${t.matricule}"/>
                </div> 
