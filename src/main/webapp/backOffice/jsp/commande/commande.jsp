...
function filterFunction() {
                      ...
                      <div class="card-body">
                           ...
                           <form action="saveTache.do" method="post">
                                <table class="table " id="dataTable"  width="100%" cellspacing="0">
                                    <thead>
                                         <tr>
                                           <th></th><th>ID</th><th>Nom Client</th><th>Numero Telephone</th><th>Adresse Client</th><th>Date Commande</th><th>Date Livraison</th><th>Durre</th><th>Prix Totale</th><th></th><th></th>
                                        </tr>
                                     </thead>
                                     <tbody>
                              <c:forEach items="${model.commandes}" var="c">
                                <tr id='parents'>
                                 ...
                                 <td><input type="checkbox" name="creeTache" value="${c.id}" ></td>
                                  <td >${c.id }</td>
                                  <td >${c.nomComplet }</td> 
                                  ...
                                  <td>${c.prixTotale}</td>
                                     ...
                                     <td>
                                     <button type="button"  class="btn btn-danger" data-toggle="modal" data-target="#supprimerModal${c.id}">
                                  	<i class="fa fa-trash" aria-hidden="true"></i>
                                  </button>
                                  </td>
                                  <td><a href="voireProduits.do?id=${c.id }"><button type="button" class="btn btn-primary">Produits</button></a></td>
                                </tr>
                               
                              </c:forEach>
                              </tbody>
                           </table>
                            <button  type="submit" class="btn btn-primary float-right" >Livrer </button>
                            </form>
                      </div>
                  </div>
            </div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
          ...
          <c:forEach items="${model.commandes}" var="c">
         <div class="modal fade" id="supprimerModal${c.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">Sélectionnez "supprimer" ci-dessous si vous souhaitez supprimer </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                   <a href="supprimerCommande.do?id=${c.id }"><button type="submit" class="btn btn-danger">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
