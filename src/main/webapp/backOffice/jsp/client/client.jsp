                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table " id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                             <th>ID</th><th>Nom Complet</th><th>Email</th><th>Numero Telephone</th><th>Date Naissance</th><th>Adresse</th><th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <button  type="submit" class="btn btn-danger" data-toggle="modal" data-target="#supprimerModal${c.id }">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Sélectionnez "supprimer" ci-dessous si vous souhaitez supprimer ce client : ${c.nomComplet}</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                   <a href="supprimerClient.do?id=${c.id}"><button type="submit" class="btn btn-danger">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
