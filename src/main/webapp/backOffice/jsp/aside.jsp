            ...
            <li class="nav-item">
                ...
                <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="chercherLivreur.do?motCle=#myModaledit">Saisie Livreur</a>
                    </div>
                </div>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="input-group  navbar-search dropdown">
                           ...
                           <div class=" dropdown-menu list-group-flush" id="myDropdown" >
                               ...
                               <a href="chercherCommande.do" class="list-group-item list-group-item-action ">Commands</a>
                               <a href="chercherCommandeLivrer.do" class="list-group-item list-group-item-action ">Commands Livrer</a>
