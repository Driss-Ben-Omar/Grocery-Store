...
function filterFunction() {
    ...
    <div id="wrapper">
                ...
                <div id="collapseone" class="collapse" aria-labelledby="headingone" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="chercherVoiture.do?motCle=">Voitures</a>
                       	<a  href='' data-toggle="modal" data-target="#myModal" class="collapse-item">Saisie Voiture</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="input-group  navbar-search dropdown">
                           ...
                           <div class=" dropdown-menu list-group-flush" id="myDropdown" >
                               ...
                               <a  href='' data-toggle="modal" data-target="#myModal" class="list-group-item list-group-item-action">Saisie Voiture</a>
                ...
                <div class="container">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Voiture</h1>
                    </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <h4 class="modal-title ">Saisie Voiture</h4>
            ...
            <form action="saveVoiture.do" method="post">
               ...
               <div>
                  <button type="submit" class="btn btn-primary">Ajouter</button>
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">les Voitures</h6>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table " id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                             <th>Matricule</th><th>Marque</th><th></th><th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>${v.marque }</td>
                                     <td>
                                      ...
                                      <button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#supprimerModal${v.matricule}">
                                      	<i class="fa fa-trash" aria-hidden="true"></i>
                                      </button>
                                  </td>
                                    <td>
                                        <button type="submit"  class="btn btn-warning" data-toggle="modal" data-target="#myModaledit${v.matricule}">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
          ...
          <c:forEach items="${model.voitures}" var="v">
         <div class="modal fade" id="supprimerModal${v.matricule}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">Sélectionnez "supprimer" ci-dessous si vous souhaitez supprimer ça voiture : ${v.marque}</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                   <a href="supprimerVoiture.do?id=${v.matricule}"><button type="submit" class="btn btn-danger">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
    
    <div id="myModaledit${v.matricule}" class="modal fade" role="dialog">
      <div class="modal-dialog">
    
        <!-- Modal content-->
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">editer voiture</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
