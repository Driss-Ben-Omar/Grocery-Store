...
function filterFunction() {
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a  href='' data-toggle="modal" data-target="#myModal" class="collapse-item">Saisie Livreur</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="input-group  navbar-search dropdown">
                           ...
                           <div class=" dropdown-menu list-group-flush" id="myDropdown" >
								...
								<a href='' data-toggle="modal" data-target="#myModal" class="list-group-item list-group-item-action">Saisie Livreur</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Livreur</h1>
                    </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <h4 class="modal-title ">Saisie Livreur</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">

            <form action="saveLivreur.do" method="post">
              ...
              <div class="form-group">
               ...
               <div>
                  <button type="submit" class="btn btn-primary">Ajouter</button>
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">les Livreurs</h6>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table " id="dataTable" width="100%" cellspacing="0" style="text-align: center;">
                                    <thead>
                                        <tr>
                                             <th>CIN</th><th>Nom Complet</th><th>Date Naissance</th><th>Adresse</th><th>Numero Telephone</th><th></th><th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                         <c:forEach items="${model.livreurs}" var="l">
                                <tr>
                                  <td>${l.cin }</td>
                                  <td>${l.nomComplet }</td>
                                  <td>${l.dateNaissance }</td>
                                  <td>${l.adresse}</td>
                                  <td>${l.numeroTelephone}</td>
                                  <td>
                                      
                                      <button type="submit" " class="btn btn-danger" data-toggle="modal" data-target="#supprimerModal${l.cin }">
                                      	<i class="fa fa-trash" aria-hidden="true"></i>
                                      </button>
                                  </td>
                                  <td>
                                        <button type="submit"  class="btn btn-warning" data-toggle="modal" data-target="#myModaledit${l.cin }">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
          ...
          <c:forEach items="${model.livreurs}" var="l">
         <div class="modal fade" id="supprimerModal${l.cin}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">Sélectionnez "supprimer" ci-dessous si vous souhaitez supprimer ce livreur : ${l.nomComplet}</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                   <a href="supprimerLivreur.do?id=${l.cin}"><button type="submit" class="btn btn-danger">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
    
    <div id="myModaledit${l.cin}" class="modal fade" role="dialog">
      <div class="modal-dialog">
    
        <!-- Modal content-->
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">editer Livreur</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
            ...
            <form action="updateLivreur.do" method="post">
                <div  hidden class="form-group">
                     <label class="control-label">CIN :</label>
                     <input type="text" name="cin" class="form-control" value="${l.cin}"/>
                </div>
                
                <div class="form-group">
                     <label class="control-label">Nom Complet :</label>
                     <input type="text" name="nomComplet" class="form-control" value="${l.nomComplet}"/>
                 </div>
                 
                <div class="form-group">
                      <label class="control-label">Date Naissance :</label>
                      <input type="text" name="dateNaissance" class="form-control" value="${l.dateNaissance}"/>
                </div> 
                
                 <div class="form-group">
                      <label class="control-label">Adresse :</label>
                      <input type="text" name="adresse" class="form-control" value="${l.adresse}"/>
                </div> 
                
                <div class="form-group">
                      <label class="control-label">Numero Telephone :</label>
                      <input type="text" name="numeroTelephone" class="form-control" value="${l.numeroTelephone}"/>
                </div> 
