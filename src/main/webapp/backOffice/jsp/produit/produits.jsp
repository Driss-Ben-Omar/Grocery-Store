...
function filterFunction() {
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a  href='' data-toggle="modal" data-target="#myModal" class="collapse-item">Saisie Produit</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="input-group  navbar-search dropdown">
                           ...
                           <div class=" dropdown-menu list-group-flush" id="myDropdown" >
                                ...
                                <a  href='' data-toggle="modal" data-target="#myModal" class="list-group-item list-group-item-action">Saisie Produit</a>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <h4 class="modal-title ">Saisie Produit</h4>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table " id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                             <th>ID</th><th>Nom Produit</th><th>Prix</th><th>Prix Dachat</th><th>Quantite</th><th>Quantite vendue</th><th>remise</th><th>profit</th><th></th><th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>${p.prixAchat}</td>
                                  <td>${p.quantite}</td>
                                  <td>${p.getQuantiteVendue()}</td>
                                  <td>${p.remise}</td>
                                  <td>${p.profit}</td>
                                      <td>
                                      
                                      <button type="submit"  class="btn btn-danger" data-toggle="modal" data-target="#supprimerModal${p.idProduit }">
										<i class="fa fa-trash" aria-hidden="true"></i> 
                                      </button>
                                  </td>
                                  <td>
                                        <button type="submit"  class="btn btn-warning" data-toggle="modal" data-target="#myModaledit${p.idProduit }">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
          ...
          <c:forEach items="${model.produits}" var="p">
         <div class="modal fade" id="supprimerModal${p.idProduit}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">Sélectionnez "supprimer" ci-dessous si vous souhaitez supprimer ce produit : ${p.nomProduit}</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                   <a href="supprimer.do?id=${p.idProduit}"><button type="submit" class="btn btn-danger">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
    
    <div id="myModaledit${p.idProduit}" class="modal fade" role="dialog">
      <div class="modal-dialog">
          ...
          <div class="modal-body">
            ...
            <form action="update.do" method="post">
                <div  hidden class="form-group">
                     ...
                     <input type="text" name="id" class="form-control" value="${p.idProduit}"/>
                </div>
                
                <div class="form-group">
                     <label class="control-label">Nom Produit :</label>
                     <input type="text" name="nom" class="form-control" value="${p.nomProduit}"/>
                 </div>
                 
                <div class="form-group">
                      <label class="control-label">Prix :</label>
                      <input type="text" name="prix" class="form-control" value="${p.prix}"/>
                </div> 
                
                 <div class="form-group">
                      <label class="control-label">Prix d'achat :</label>
                      <input type="text" name="prixAchat" class="form-control" value="${p.prixAchat}"/>
                </div> 
                
                <div class="form-group">
                      <label class="control-label">Quantite :</label>
                      <input type="text" name="quantite" class="form-control" value="${p.quantite}"/>
                </div> 
                
                <div class="form-group">
                      <label class="control-label">Quantite Vendue :</label>
                      <input type="text" name="quantiteVendue" class="form-control" value="${p.getQuantiteVendue()}"/>
                </div> 
                
                 <div class="form-group">
                      <label class="control-label">Remise :</label>
                      <input type="text" name="remise" class="form-control" value="${p.remise}"/>
                </div>
                <div class="form-group">
                <button type="button" data-dismiss="modal" class="btn btn-info" data-toggle="modal" data-target="#addphoto${p.idProduit}">
                   <i class="fa fa-file-image-o" aria-hidden="true"></i> choisir une photo
                   </button>
                </div>
    ...
    <div id="addphoto${p.idProduit}" class="modal fade" role="dialog">
      <div class="modal-dialog">
            ...
            <form action="Upload" method="post"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                        ...
                        <input type='submit' class="btn btn-primary" value='upload'></div></form>
                 </div></div>
