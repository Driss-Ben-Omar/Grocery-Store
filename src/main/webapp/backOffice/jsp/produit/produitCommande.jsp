                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                         ...
                         <button type="button"  class="btn btn-primary float-right" data-toggle="modal" data-target="#myModal">Saisie Produit</button> 
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                             <th>ID</th><th>Nom Produit</th><th>Prix</th><th>Prix Dachat</th><th>Quantite</th><th>Quantite vendue</th><th>remise</th><th>profit</th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                   ...
                   <a href="supprimer.do?id=${p.idProduit}"><button type="submit" class="btn btn-primary">Supprimer</button></a>
                </div>
            </div>
        </div>
    </div> 
